...
//           </div>
//           <Link to="/" className="btn bg-blue-600 rounded-xl">C</Link>
//         </div>
//         <div className="navbar-center hidden lg:flex">
//           <ul className="menu menu-horizontal px-1">
//             <li className="rounded-md"><NavLink to="/">Home</NavLink></li>
  ...
  return (
    <div className="bg-base-200">
      ...
      <div className="navbar bg-base-200 mx-auto max-w-6xl ">
        <div className="container mx-auto">
          {/* <div className="navbar-start">
            <Link to="/" className="btn bg-blue-600 rounded-xl">
              C
            </Link>
          </div> */}
          <div className="navbar-start">
            <div className="dropdown">
              ...
              >
                ...
                <li>
                  <NavLink className="rounded-lg" to="/products">
                    Products
                  </NavLink>
                </li>
                {token.token && (
                  <>
                    <li>
                      <NavLink className="rounded-lg" to="/checkout">
                        Checkout
                      </NavLink>
                    </li>
                    <li>
                      <NavLink className="rounded-lg" to="/orders">
                        Orders
                      </NavLink>
                    </li>
                  </>
                ...
                <li>
                  <NavLink className="rounded-lg" to="/cart">
                    Cart
                  </NavLink>
                </li>
              </ul>
            ...
            <Link to="/"
             className="btn bg-blue-600 rounded-xl">
              C
            </Link>
          </div>
          <div className="navbar-center hidden lg:flex">
          ...
          <div className="navbar-end flex justify-end gap-5">
            {/* Removed unused sun/moon icon functionality */}
            <label className="swap swap-rotate">
              {/* this hidden checkbox controls the state */}
              <input
                type="checkbox"
                className="theme-controller max-w-3"
                value="synthwave"
              />
              {/* sun icon */}
              <svg
