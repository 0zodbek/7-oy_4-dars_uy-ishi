    ...
    <div>
      <div className="container px-8 py-20 mx-auto max-w-6xl flex justify-between">
        <div className="max-w-lg flex flex-wrap  items-center">
          ...
          <Link to="/products" className="text-white btn btn-info rounded-lg">OUR PRODUCTS</Link>
        </div>
      ...
      <div className="featuredproducts">
        <h2 className="max-w-6xl mx-auto text-3xl font-medium tracking-wider capitalize pb-5">featured products</h2>
            ...
            return(
                <a style={{width: "352px", height: "332px"}} className=" shadow-xl hover:shadow-2xl transition duration-300 p-4  rounded-2xl" href={`/products/${el.id}`} key={index}>
                    ...
                    <div className="flex flex-col gap-2">
                        <h3 className="pt-9 capitalize tracking-wider text-center">{el.attributes.title}</h3>
