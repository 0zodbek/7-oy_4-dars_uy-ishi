...
function Products() {
  ...
  useEffect(() => fetch("https://strapi-store-server.onrender.com/api")
    .then(res => res.json())
  ...
  if (!product) {
    return <div className="flex text-red-300 justify-center" ><img src={Loader} alt="" /></div>;
  }
      ...
      <div className="flex gap-20">
        ...
        <div className="w-1/2">
          ...
          <div className="flex items-center mb-6">
            ...
            <select className="border rounded w-44 p-2">
              {[...Array(10).keys()].map(i => (
